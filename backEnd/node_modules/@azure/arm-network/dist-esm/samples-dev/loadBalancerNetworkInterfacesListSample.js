 ...
 */
function loadBalancerNetworkInterfaceListSimple() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.loadBalancerNetworkInterfaces.list(resourceGroupName, loadBalancerName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function loadBalancerNetworkInterfaceListVmss() {
    var _a, e_2, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "testrg";
...
//# sourceMappingURL=loadBalancerNetworkInterfacesListSample.js.map