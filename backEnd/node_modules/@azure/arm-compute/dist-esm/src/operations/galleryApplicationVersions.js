...
export class GalleryApplicationVersionsImpl {
    ...
    listByGalleryApplicationPagingPage(resourceGroupName, galleryName, galleryApplicationName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByGalleryApplicationPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByGalleryApplication(resourceGroupName, galleryName, galleryApplicationName, options));
    ...
    listByGalleryApplicationPagingAll(resourceGroupName, galleryName, galleryApplicationName, options) {
        return __asyncGenerator(this, arguments, function* listByGalleryApplicationPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByGalleryApplicationPagingPage(resourceGroupName, galleryName, galleryApplicationName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
