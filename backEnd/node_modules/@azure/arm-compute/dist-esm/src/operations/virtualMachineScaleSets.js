...
export class VirtualMachineScaleSetsImpl {
    ...
    listSkusPagingPage(resourceGroupName, vmScaleSetName, options, settings) {
        return __asyncGenerator(this, arguments, function* listSkusPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listSkus(resourceGroupName, vmScaleSetName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listSkusPagingAll(resourceGroupName, vmScaleSetName, options) {
        return __asyncGenerator(this, arguments, function* listSkusPagingAll_1() {
            var _a, e_4, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listSkusPagingPage(resourceGroupName, vmScaleSetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
    ...
    getOSUpgradeHistoryPagingPage(resourceGroupName, vmScaleSetName, options, settings) {
        return __asyncGenerator(this, arguments, function* getOSUpgradeHistoryPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._getOSUpgradeHistory(resourceGroupName, vmScaleSetName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    getOSUpgradeHistoryPagingAll(resourceGroupName, vmScaleSetName, options) {
        return __asyncGenerator(this, arguments, function* getOSUpgradeHistoryPagingAll_1() {
            var _a, e_5, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.getOSUpgradeHistoryPagingPage(resourceGroupName, vmScaleSetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    beginReapply(resourceGroupName, vmScaleSetName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginReapplyAndWait(resourceGroupName, vmScaleSetName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginReapply(resourceGroupName, vmScaleSetName, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginApproveRollingUpgrade(resourceGroupName, vmScaleSetName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginApproveRollingUpgradeAndWait(resourceGroupName, vmScaleSetName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginApproveRollingUpgrade(resourceGroupName, vmScaleSetName, options);
            return poller.pollUntilDone();
        });
    }
    /**
