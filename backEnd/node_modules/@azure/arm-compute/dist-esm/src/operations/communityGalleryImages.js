...
export class CommunityGalleryImagesImpl {
    ...
    listPagingPage(location, publicGalleryName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(location, publicGalleryName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(location, publicGalleryName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(location, publicGalleryName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(location, publicGalleryName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    get(location, publicGalleryName, galleryImageName, options) {
        return this.client.sendOperationRequest({ location, publicGalleryName, galleryImageName, options }, getOperationSpec);
    }
    /**
     * List community gallery images inside a gallery.
     * @param location Resource location.
    ...
    _list(location, publicGalleryName, options) {
        return this.client.sendOperationRequest({ location, publicGalleryName, options }, listOperationSpec);
    }
    /**
     * ListNext
     * @param location Resource location.
    ...
    _listNext(location, publicGalleryName, nextLink, options) {
        return this.client.sendOperationRequest({ location, publicGalleryName, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=communityGalleryImages.js.map