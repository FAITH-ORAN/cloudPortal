...
export class GalleryApplicationsImpl {
    ...
    listByGalleryPagingPage(resourceGroupName, galleryName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByGalleryPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByGallery(resourceGroupName, galleryName, options));
    ...
    listByGalleryPagingAll(resourceGroupName, galleryName, options) {
        return __asyncGenerator(this, arguments, function* listByGalleryPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByGalleryPagingPage(resourceGroupName, galleryName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
