...
export class VirtualMachineScaleSetVMRunCommandsImpl {
    ...
    listPagingPage(resourceGroupName, vmScaleSetName, instanceId, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, vmScaleSetName, instanceId, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, vmScaleSetName, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, vmScaleSetName, instanceId, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, vmScaleSetName, instanceId, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    _listNext(resourceGroupName, vmScaleSetName, instanceId, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, vmScaleSetName, instanceId, nextLink, options }, listNextOperationSpec);
    }
}
