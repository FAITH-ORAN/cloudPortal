...
export class VirtualMachineScaleSetVMsImpl {
    ...
    listPagingPage(resourceGroupName, virtualMachineScaleSetName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, virtualMachineScaleSetName, options));
    ...
    listPagingAll(resourceGroupName, virtualMachineScaleSetName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, virtualMachineScaleSetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    beginApproveRollingUpgrade(resourceGroupName, vmScaleSetName, instanceId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginApproveRollingUpgradeAndWait(resourceGroupName, vmScaleSetName, instanceId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginApproveRollingUpgrade(resourceGroupName, vmScaleSetName, instanceId, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginAttachDetachDataDisks(resourceGroupName, vmScaleSetName, instanceId, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginAttachDetachDataDisksAndWait(resourceGroupName, vmScaleSetName, instanceId, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginAttachDetachDataDisks(resourceGroupName, vmScaleSetName, instanceId, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
