...
export class AvailabilitySetsImpl {
    ...
    listAvailableSizesPagingPage(resourceGroupName, availabilitySetName, options, _settings) {
        return __asyncGenerator(this, arguments, function* listAvailableSizesPagingPage_1() {
            let result;
            result = yield __await(this._listAvailableSizes(resourceGroupName, availabilitySetName, options));
    ...
    listAvailableSizesPagingAll(resourceGroupName, availabilitySetName, options) {
        return __asyncGenerator(this, arguments, function* listAvailableSizesPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listAvailableSizesPagingPage(resourceGroupName, availabilitySetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
