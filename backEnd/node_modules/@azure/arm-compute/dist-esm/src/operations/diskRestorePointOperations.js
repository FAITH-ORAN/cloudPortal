...
export class DiskRestorePointOperationsImpl {
    ...
    listByRestorePointPagingPage(resourceGroupName, restorePointCollectionName, vmRestorePointName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByRestorePointPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByRestorePoint(resourceGroupName, restorePointCollectionName, vmRestorePointName, options));
    ...
    listByRestorePointPagingAll(resourceGroupName, restorePointCollectionName, vmRestorePointName, options) {
        return __asyncGenerator(this, arguments, function* listByRestorePointPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByRestorePointPagingPage(resourceGroupName, restorePointCollectionName, vmRestorePointName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
