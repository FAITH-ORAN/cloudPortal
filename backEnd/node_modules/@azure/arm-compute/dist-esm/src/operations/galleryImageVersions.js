...
export class GalleryImageVersionsImpl {
    ...
    listByGalleryImagePagingPage(resourceGroupName, galleryName, galleryImageName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByGalleryImagePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByGalleryImage(resourceGroupName, galleryName, galleryImageName, options));
    ...
    listByGalleryImagePagingAll(resourceGroupName, galleryName, galleryImageName, options) {
        return __asyncGenerator(this, arguments, function* listByGalleryImagePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByGalleryImagePagingPage(resourceGroupName, galleryName, galleryImageName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
