...
export class VirtualMachinesImpl {
    ...
    listAvailableSizesPagingPage(resourceGroupName, vmName, options, _settings) {
        return __asyncGenerator(this, arguments, function* listAvailableSizesPagingPage_1() {
            let result;
            result = yield __await(this._listAvailableSizes(resourceGroupName, vmName, options));
    ...
    listAvailableSizesPagingAll(resourceGroupName, vmName, options) {
        return __asyncGenerator(this, arguments, function* listAvailableSizesPagingAll_1() {
            var _a, e_4, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listAvailableSizesPagingPage(resourceGroupName, vmName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    beginAttachDetachDataDisks(resourceGroupName, vmName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginAttachDetachDataDisksAndWait(resourceGroupName, vmName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginAttachDetachDataDisks(resourceGroupName, vmName, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
