...
export class VirtualMachineRunCommandsImpl {
    ...
    listByVirtualMachinePagingPage(resourceGroupName, vmName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByVirtualMachinePagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByVirtualMachine(resourceGroupName, vmName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByVirtualMachinePagingAll(resourceGroupName, vmName, options) {
        return __asyncGenerator(this, arguments, function* listByVirtualMachinePagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByVirtualMachinePagingPage(resourceGroupName, vmName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
