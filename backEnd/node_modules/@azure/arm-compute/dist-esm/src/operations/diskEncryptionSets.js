...
export class DiskEncryptionSetsImpl {
    ...
    listAssociatedResourcesPagingPage(resourceGroupName, diskEncryptionSetName, options, settings) {
        return __asyncGenerator(this, arguments, function* listAssociatedResourcesPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listAssociatedResources(resourceGroupName, diskEncryptionSetName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listAssociatedResourcesNext(resourceGroupName, diskEncryptionSetName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listAssociatedResourcesPagingAll(resourceGroupName, diskEncryptionSetName, options) {
        return __asyncGenerator(this, arguments, function* listAssociatedResourcesPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listAssociatedResourcesPagingPage(resourceGroupName, diskEncryptionSetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
