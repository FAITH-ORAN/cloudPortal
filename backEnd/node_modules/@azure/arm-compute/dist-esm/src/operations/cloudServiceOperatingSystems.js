...
export class CloudServiceOperatingSystemsImpl {
    ...
    listOSVersionsPagingPage(location, options, settings) {
        return __asyncGenerator(this, arguments, function* listOSVersionsPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listOSVersions(location, options));
    ...
    listOSVersionsPagingAll(location, options) {
        return __asyncGenerator(this, arguments, function* listOSVersionsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listOSVersionsPagingPage(location, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    listOSFamiliesPagingPage(location, options, settings) {
        return __asyncGenerator(this, arguments, function* listOSFamiliesPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listOSFamilies(location, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listOSFamiliesPagingAll(location, options) {
        return __asyncGenerator(this, arguments, function* listOSFamiliesPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listOSFamiliesPagingPage(location, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
