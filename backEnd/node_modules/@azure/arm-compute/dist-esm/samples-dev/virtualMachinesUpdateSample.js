 ...
 */
function updateAVMByDetachingDataDisk() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachines.beginUpdateAndWait(resourceGroupName, vmName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function updateAVMByForceDetachingDataDisk() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const vmName = "myVM";
