 ...
 */
function getAGalleryImageVersionWithReplicationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.galleryImageVersions.get(resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, options);
        console.log(result);
    });
}
/**
...
function getAGalleryImageVersionWithSnapshotsAsASource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.galleryImageVersions.get(resourceGroupName, galleryName, galleryImageName, galleryImageVersionName);
        console.log(result);
    });
}
/**
 ...
 */
function getAGalleryImageVersionWithVhdAsASource() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
 ...
 */
function getAGalleryImageVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
...
//# sourceMappingURL=galleryImageVersionsGetSample.js.map