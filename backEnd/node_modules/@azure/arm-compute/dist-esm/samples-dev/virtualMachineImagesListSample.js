 ...
 */
function virtualMachineImageListMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineImages.list(location, publisherName, offer, skus, options);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineImageListMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.virtualMachineImages.list(location, publisherName, offer, skus);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualMachineImagesListSample.js.map