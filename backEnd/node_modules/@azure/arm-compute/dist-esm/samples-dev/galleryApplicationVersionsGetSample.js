 ...
 */
function getAGalleryApplicationVersionWithReplicationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.galleryApplicationVersions.get(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, options);
        console.log(result);
    });
}
/**
 ...
 */
function getAGalleryApplicationVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.galleryApplicationVersions.get(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=galleryApplicationVersionsGetSample.js.map