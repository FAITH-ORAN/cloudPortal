 ...
 */
function capacityReservationUpdateMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.capacityReservations.beginUpdateAndWait(resourceGroupName, capacityReservationGroupName, capacityReservationName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function capacityReservationUpdateMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
...
//# sourceMappingURL=capacityReservationsUpdateSample.js.map