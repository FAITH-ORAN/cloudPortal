 ...
 */
function getASasOnAManagedDisk() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.disks.beginGrantAccessAndWait(resourceGroupName, diskName, grantAccessData);
        console.log(result);
    });
}
/**
 ...
 */
function getSasOnManagedDiskAndVMGuestState() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const diskName = "myDisk";
...
//# sourceMappingURL=disksGrantAccessSample.js.map