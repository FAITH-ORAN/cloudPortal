 ...
 */
function createADiskEncryptionSetWithKeyVaultFromADifferentSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.diskEncryptionSets.beginCreateOrUpdateAndWait(resourceGroupName, diskEncryptionSetName, diskEncryptionSet);
        console.log(result);
    });
}
/**
 ...
 */
function createADiskEncryptionSetWithKeyVaultFromADifferentTenant() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const diskEncryptionSetName = "myDiskEncryptionSet";
 ...
 */
function createADiskEncryptionSet() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const diskEncryptionSetName = "myDiskEncryptionSet";
...
//# sourceMappingURL=diskEncryptionSetsCreateOrUpdateSample.js.map