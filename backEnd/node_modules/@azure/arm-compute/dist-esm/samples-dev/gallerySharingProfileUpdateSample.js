 ...
 */
function addSharingIdToTheSharingProfileOfAGallery() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.gallerySharingProfile.beginUpdateAndWait(resourceGroupName, galleryName, sharingUpdate);
        console.log(result);
    });
}
/**
 ...
 */
function shareAGalleryToCommunity() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
...
//# sourceMappingURL=gallerySharingProfileUpdateSample.js.map