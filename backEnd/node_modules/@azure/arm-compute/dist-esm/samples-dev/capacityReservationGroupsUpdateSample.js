 ...
 */
function capacityReservationGroupUpdateMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.capacityReservationGroups.update(resourceGroupName, capacityReservationGroupName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function capacityReservationGroupUpdateMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
        const capacityReservationGroupName = "aaaaaaaaaaaaaaaaaaaaaa";
...
//# sourceMappingURL=capacityReservationGroupsUpdateSample.js.map