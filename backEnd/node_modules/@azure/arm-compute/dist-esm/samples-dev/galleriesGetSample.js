...
function getACommunityGallery() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.galleries.get(resourceGroupName, galleryName);
        console.log(result);
    });
}
/**
 ...
 */
function getAGalleryWithExpandSharingProfileGroups() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.galleries.get(resourceGroupName, galleryName, options);
        console.log(result);
    });
}
/**
 ...
 */
function getAGalleryWithSelectPermissions() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
...
//# sourceMappingURL=galleriesGetSample.js.map