 ...
 */
function virtualMachineScaleSetVMAttachDetachDataDisksMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetVMs.beginAttachDetachDataDisksAndWait(resourceGroupName, vmScaleSetName, instanceId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineScaleSetVMAttachDetachDataDisksMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
        const vmScaleSetName = "azure-vmscaleset";
...
//# sourceMappingURL=virtualMachineScaleSetVMSAttachDetachDataDisksSample.js.map