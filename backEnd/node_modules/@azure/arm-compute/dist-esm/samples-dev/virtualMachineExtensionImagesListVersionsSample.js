 ...
 */
function virtualMachineExtensionImageListVersionsMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensionImages.listVersions(location, publisherName, typeParam, options);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineExtensionImageListVersionsMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.virtualMachineExtensionImages.listVersions(location, publisherName, typeParam);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualMachineExtensionImagesListVersionsSample.js.map