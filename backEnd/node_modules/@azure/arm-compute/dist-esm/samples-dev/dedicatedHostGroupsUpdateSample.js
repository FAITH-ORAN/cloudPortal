 ...
 */
function dedicatedHostGroupUpdateMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.dedicatedHostGroups.update(resourceGroupName, hostGroupName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function dedicatedHostGroupUpdateMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
...
//# sourceMappingURL=dedicatedHostGroupsUpdateSample.js.map