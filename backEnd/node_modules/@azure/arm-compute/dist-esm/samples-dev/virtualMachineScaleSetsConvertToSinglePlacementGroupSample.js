 ...
 */
function virtualMachineScaleSetConvertToSinglePlacementGroupMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSets.convertToSinglePlacementGroup(resourceGroupName, vmScaleSetName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineScaleSetConvertToSinglePlacementGroupMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
...
//# sourceMappingURL=virtualMachineScaleSetsConvertToSinglePlacementGroupSample.js.map