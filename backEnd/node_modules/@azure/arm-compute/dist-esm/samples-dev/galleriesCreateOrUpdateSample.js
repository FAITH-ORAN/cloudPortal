 ...
 */
function createACommunityGallery() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.galleries.beginCreateOrUpdateAndWait(resourceGroupName, galleryName, gallery);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateASimpleGallery() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
...
//# sourceMappingURL=galleriesCreateOrUpdateSample.js.map