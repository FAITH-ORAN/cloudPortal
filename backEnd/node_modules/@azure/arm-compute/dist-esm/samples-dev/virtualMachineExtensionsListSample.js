 ...
 */
function virtualMachineExtensionListMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensions.list(resourceGroupName, vmName, options);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineExtensionListMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.virtualMachineExtensions.list(resourceGroupName, vmName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualMachineExtensionsListSample.js.map