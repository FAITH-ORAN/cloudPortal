 ...
 */
function virtualMachineImagesEdgeZoneListMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineImagesEdgeZone.list(location, edgeZone, publisherName, offer, skus, options);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineImagesEdgeZoneListMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.virtualMachineImagesEdgeZone.list(location, edgeZone, publisherName, offer, skus);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualMachineImagesEdgeZoneListSample.js.map