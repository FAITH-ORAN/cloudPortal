 ...
 */
function updateASimpleGalleryImageVersionManagedImageAsSource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.galleryImageVersions.beginUpdateAndWait(resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, galleryImageVersion);
        console.log(result);
    });
}
/**
 ...
 */
function updateASimpleGalleryImageVersionWithoutSourceId() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
...
//# sourceMappingURL=galleryImageVersionsUpdateSample.js.map