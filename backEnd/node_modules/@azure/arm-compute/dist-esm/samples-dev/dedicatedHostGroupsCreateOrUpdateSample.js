 ...
 */
function createOrUpdateADedicatedHostGroupWithUltraSsdSupport() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.dedicatedHostGroups.createOrUpdate(resourceGroupName, hostGroupName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateADedicatedHostGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const hostGroupName = "myDedicatedHostGroup";
...
//# sourceMappingURL=dedicatedHostGroupsCreateOrUpdateSample.js.map