 ...
 */
function virtualMachineScaleSetExtensionCreateOrUpdateMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetExtensions.beginCreateOrUpdateAndWait(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineScaleSetExtensionCreateOrUpdateMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "rgcompute";
...
//# sourceMappingURL=virtualMachineScaleSetExtensionsCreateOrUpdateSample.js.map