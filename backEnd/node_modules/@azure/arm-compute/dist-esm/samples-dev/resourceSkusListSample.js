 ...
 */
function listsAllAvailableResourceSkUs() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.resourceSkus.list()), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function listsAllAvailableResourceSkUsForTheSpecifiedRegion() {
    var _a, e_2, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        ...
        const resArray = new Array();
        try {
            for (var _d = true, _e = __asyncValues(client.resourceSkus.list(options)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function listsAllAvailableResourceSkUsWithExtendedLocationInformation() {
    var _a, e_3, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
