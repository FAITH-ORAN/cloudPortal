...
export declare interface AlternativeOption {
 ...
 * **Plan**
 */
export declare type AlternativeType = string;
...
/** This is the community gallery image definition identifier. */
export declare interface CommunityGalleryImageIdentifier {
...
export declare interface DedicatedHostSizeListResult {
    /** The list of dedicated host sizes. */
    value?: string[];
}

/** Optional parameters. */
export declare interface DedicatedHostsListAvailableSizesOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listAvailableSizes operation. */
export declare type DedicatedHostsListAvailableSizesResponse = DedicatedHostSizeListResult;
...
export declare interface DiskRestorePointAttributes extends SubResourceReadOnly {
 ...
 * **NoReuse**
 */
export declare type DomainNameLabelScopeTypes = string;
 ...
 * **Premium_LRS**
 */
export declare type EdgeZoneStorageAccountType = string;
 ...
 * **instanceView**
 */
export declare type ExpandTypeForListVMs = string;
 ...
 * **instanceView**
 */
export declare type ExpandTypesForListVMs = string;
...
export declare interface GalleryApplicationCustomAction {
...
export declare interface GalleryApplicationCustomActionParameter {
    /** The name of the custom action.  Must be unique within the Gallery Application Version. */
    name: string;
...
export declare type GalleryApplicationCustomActionParameterType = "String" | "ConfigurationDataBlob" | "LogOutputBlob";
...
/** The safety profile of the Gallery Application Version. */
export declare interface GalleryApplicationVersionSafetyProfile extends GalleryArtifactSafetyProfileBase {
}
...
export declare interface GalleryArtifactSafetyProfileBase {
...
export declare interface GalleryArtifactVersionFullSource extends GalleryArtifactVersionSource {
...
/** The source for the disk image. */
export declare interface GalleryDiskImageSource extends GalleryArtifactVersionSource {
...
/** This is the safety profile of the Gallery Image Version. */
export declare interface GalleryImageVersionSafetyProfile extends GalleryArtifactSafetyProfileBase {
    /**
...
export declare interface ImageDeprecationStatus {
 ...
 * **Deprecated**
 */
export declare type ImageState = string;
...
export declare interface LatestGalleryImageVersion {
 ...
 * **Floating**
 */
export declare type NetworkInterfaceAuxiliaryMode = string;
 ...
 * **A8**
 */
export declare type NetworkInterfaceAuxiliarySku = string;
...
export declare interface OSImageNotificationProfile {
...
export declare interface OSProfileProvisioningData {
    /** Specifies the password of the administrator account. <br><br> **Minimum-length (Windows):** 8 characters <br><br> **Minimum-length (Linux):** 6 characters <br><br> **Max-length (Windows):** 123 characters <br><br> **Max-length (Linux):** 72 characters <br><br> **Complexity requirements:** 3 out of 4 conditions below need to be fulfilled <br> Has lower characters <br>Has upper characters <br> Has a digit <br> Has a special character (Regex match [\W_]) <br><br> **Disallowed values:** "abc@123", "P@$$w0rd", "P@ssw0rd", "P@ssword123", "Pa$$word", "pass@word1", "Password!", "Password1", "Password22", "iloveyou!" <br><br> For resetting the password, see [How to reset the Remote Desktop service or its login password in a Windows VM](https://docs.microsoft.com/troubleshoot/azure/virtual-machines/reset-rdp) <br><br> For resetting root password, see [Manage users, SSH, and check or repair disks on Azure Linux VMs using the VMAccess Extension](https://docs.microsoft.com/troubleshoot/azure/virtual-machines/troubleshoot-ssh-connection) */
    adminPassword?: string;
 ...
 * **IpTheft**
 */
export declare type PolicyViolationCategory = string;
 ...
 * **Enhanced**
 */
export declare type ProvisionedBandwidthCopyOption = string;
...
/** Encryption at rest settings for disk restore point. It is an optional property that can be specified in the input while creating a restore point. */
export declare interface RestorePointEncryption {
    /** Describes the parameter of customer managed disk encryption set resource id that can be specified for disk. **Note:** The disk encryption set resource id can only be specified for managed disk. Please refer https://aka.ms/mdssewithcmkoverview for more details. */
    diskEncryptionSet?: DiskEncryptionSetParameters;
 ...
 */
export declare type RestorePointEncryptionType = string;
...
export declare interface SecurityPostureReference {
...
export declare interface VirtualMachineScaleSetIPConfiguration {
    /** The IP configuration name. */
    name: string;
    /** Specifies the identifier of the subnet. */
...
export declare interface VirtualMachineScaleSetNetworkConfiguration {
...
export declare interface VirtualMachineScaleSetsReapplyHeaders {
    location?: string;
}

/** Optional parameters. */
export declare interface VirtualMachineScaleSetsReapplyOptionalParams extends coreClient.OperationOptions {
    /** Delay to wait until next poll, in milliseconds. */
    updateIntervalInMs?: number;
    /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
    resumeFrom?: string;
...
export declare interface VirtualMachineScaleSetUpdateIPConfiguration {
    /** The IP configuration name. */
    name?: string;
    /** The subnet. */
    subnet?: ApiEntityReference;
...
/** Describes a virtual machine scale set network profile's network configurations. */
export declare interface VirtualMachineScaleSetUpdateNetworkConfiguration {
    /** The network configuration name. */
    name?: string;
